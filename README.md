...
![Image alt](https://github.com/mintford/lab3/blob/master/lab_3/Screenshots/Лаб%203(2).PNG)

В итоге проведенной лабораторной работы была реализована программа для решения задачи Эйнштейна. Программа работает, но если поменять правила местами, то, скорее всего, она работать не будет.
